...
public class GameController : MonoBehaviour {
    ...
    egFloat cloneInterval = 3.0f;              //clone maze and enenmyball every N seconds
    ...
    void cloneEnemyBall()
    {
        ...
        eb.transform.localScale = new Vector3(eb.transform.localScale.x + scaleModifier, eb.transform.localScale.y, eb.transform.localScale.z + scaleModifier);
